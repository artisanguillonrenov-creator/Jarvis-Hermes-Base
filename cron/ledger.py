"""Stable SQLite boundary for cron stores that survive on-disk upgrades.

A running scheduler may retain this module while newer cron store modules are loaded from disk.
Keep these helper names and signatures compatible with the pre-upgrade ledger contract.
"""
