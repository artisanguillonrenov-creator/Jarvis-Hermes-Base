...
class GatewayStatusCommandsMixin:
    ...
    async def _handle_status_command(self, event: MessageEvent) -> str:
        ...
        # stays useful between turns. Read the durable override without activating its runtime:
        # /status must not resolve credentials or populate conversation state after a restart.
