...
# (deepseek/…, Qwen/…, zai-org/…, MiniMaxAI/…, nvidia/…, xiaomi/…, stepfun/…). The registry id is
# ``commandcode`` (no hyphen); ``command-code`` is not a known provider and never reaches this check.
