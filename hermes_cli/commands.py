...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("lock-this-chat-into-law", "Write a redacted checkpoint candidate packet for this chat", "Session",
               aliases=("lock_this_chat_into_law",), args_hint="[lookback] [--dry-run|--preview] [--approve-candidate-checkpoint]",
               busy_policy="dispatch"),
    CommandDef("promote-since-last-checkpoint", "Write a redacted candidate packet since the last checkpoint", "Session",
               aliases=("promote_since_last_checkpoint",), args_hint="[lookback] [--dry-run|--preview] [--approve-candidate-checkpoint]",
               busy_policy="dispatch"),
