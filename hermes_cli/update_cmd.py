...
from hermes_cli.update_cmd_git import (  # noqa: F401
    ...
    _discard_lockfile_churn, _ensure_non_trampoline_git, _fetch_with_progress, _get_origin_url,
    _git_is_trampoline,
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        fetch_result = _fetch_with_progress(
            git_cmd, branch, timeout_seconds=NETWORK_GIT_TIMEOUT_SECONDS)
        if fetch_result.returncode != 0:
            _print_fetch_failure(fetch_result.stderr)
            sys.exit(1)
