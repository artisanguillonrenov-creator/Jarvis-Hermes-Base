...
DEFAULT_CONFIG = {
    ...
    "skills": {
        ...
        # Glob patterns narrowing which skills the external_dirs tier contributes to the prompt
        # index (the profile's own skills/ dir is never filtered). Empty list = no filtering.
        # e.g. ["workflow/*", "devops/*", "github"].
        "external_include": [],
        # Glob patterns always dropped, even when external_include matches them; exclude wins.
        # e.g. ["workflow/vendor/*"]. Ignored when no external dir is configured.
        "external_exclude": [],
