...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "infermatic": HermesOverlay(extra_env_vars=("INFERMATIC_API_KEY",),
                                base_url_override="https://api.totalgpt.ai/v1",
                                base_url_env_var="INFERMATIC_BASE_URL"),
...
_ALIAS_GROUPS: Dict[str, Tuple[str, ...]] = {
    ...
    "infermatic": ("infermatic-ai", "totalgpt"),
