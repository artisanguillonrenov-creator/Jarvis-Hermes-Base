...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "minimax": HermesOverlay(transport="anthropic_messages", extra_env_vars=("MINIMAX_API_KEY",),
    ...
    "minimax-cn": HermesOverlay(transport="anthropic_messages", extra_env_vars=("MINIMAX_CN_API_KEY",),
