...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "stepfun-plan": HermesOverlay(extra_env_vars=("STEPFUN_API_KEY",),
...
_ALIAS_GROUPS: Dict[str, Tuple[str, ...]] = {
    ...
    "stepfun": ("stepfun-ai",), "stepfun-plan": ("step", "stepfun-coding-plan", "stepfun-step-plan"), "minimax-cn": ("minimax-china", "minimax_cn"),
...
_LABEL_OVERRIDES: Dict[str, str] = {
    ...
    "copilot-acp": "GitHub Copilot ACP", "stepfun": "StepFun", "stepfun-plan": "StepFun Step Plan", "xiaomi": "Xiaomi MiMo", "gmi": "GMI Cloud",
