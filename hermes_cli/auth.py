...
from hermes_cli.auth_constants import (  # noqa: F401  re-exported
    ...
    STEPFUN_STEP_PLAN_CN_BASE_URL, STEPFUN_STD_INTL_BASE_URL, STEPFUN_STD_CN_BASE_URL,
...
_REGISTRY_ROWS: Tuple[Any, ...] = (
    ...
    ("stepfun-plan", "StepFun Step Plan", STEPFUN_STEP_PLAN_INTL_BASE_URL, ("STEPFUN_API_KEY",), "STEPFUN_STEP_PLAN_BASE_URL"),
