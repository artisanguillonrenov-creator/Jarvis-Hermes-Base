...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    "stepfun-plan": ["step-3.7-flash", "step-3.5-flash", "step-3.5-flash-2603"],
    "moonshot": [
...
CANONICAL_PROVIDERS: list[ProviderEntry] = [ProviderEntry(*row) for row in (
    ...
    ("stepfun", "StepFun", "StepFun standard chat completions (Step models)"),
    ("stepfun-plan", "StepFun Step Plan", "StepFun Step Plan (Agent / coding models via Step Plan API)"),
...
_PROVIDER_ALIASES = dict((
    ...
    ("kimi-cn", "kimi-coding-cn"), ("moonshot-cn", "kimi-coding-cn"), ("step", "stepfun-plan"),
    ("stepfun-coding-plan", "stepfun-plan"), ("stepfun-step-plan", "stepfun-plan"), ("stepfun-ai", "stepfun"),
    ("arcee-ai", "arcee"), ("arceeai", "arcee"), ("gmi-cloud", "gmi"),
