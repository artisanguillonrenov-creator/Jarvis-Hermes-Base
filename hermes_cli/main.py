...
cmd_dashboard_credentials = _forward_command("cmd_dashboard_credentials", "hermes_cli.dashboard_credentials", "cmd_dashboard_credentials", doc='Configure or change the bundled dashboard basic-auth credentials.')
