...
TIPS = [
    ...
    'HERMES_STREAM_RETRIES (default 2) controls mid-stream reconnect attempts on transient network errors; agent.max_stream_retries sets the same value in config.yaml and takes precedence.',
