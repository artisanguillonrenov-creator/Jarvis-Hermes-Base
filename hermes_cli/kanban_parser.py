...
_SPECS = [
    ...
    _cmd("swarm", [
        ...
        _arg("--verifier-skill", dest="verifier_skills", action="append", default=None,
             metavar="SKILL",
             help="Skill for the verifier card (repeatable). Default: requesting-code-review"),
        _arg("--synthesizer-skill", dest="synthesizer_skills", action="append", default=None,
             metavar="SKILL",
             help="Skill for the synthesizer card (repeatable). Default: humanizer"),
        _TENANT,
        _PRIORITY,
