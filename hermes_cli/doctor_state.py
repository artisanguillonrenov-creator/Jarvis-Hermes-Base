...
def _render_state_db_stats(stats: dict, holders=None, auto_prune_enabled: bool = False,
    ...
    field. ``auto_prune_enabled`` / ``retention_days`` come from the caller's *effective* sessions
