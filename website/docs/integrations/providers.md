...
| **Cloudflare Workers AI** | `CLOUDFLARE_API_TOKEN` + `CLOUDFLARE_ACCOUNT_ID` in `~/.hermes/.env` (provider: `workers-ai`; aliases: `cloudflare`, `cloudflare-workers-ai`). OpenAI-compatible `@cf/` models. Not Vercel AI Gateway. |
