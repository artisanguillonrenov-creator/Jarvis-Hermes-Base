...
| `HERMES_STREAM_RETRIES` | Number of mid-stream reconnect attempts on transient network errors (default: `2`). Fallback for `agent.max_stream_retries`, which takes precedence when set. |
