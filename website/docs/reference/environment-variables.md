...
| `PGS_API_KEY` | Phoenix Grove API key — curated open-weights coding plan ([api.pgsgrove.com](https://api.pgsgrove.com/)) |
| `PGS_BASE_URL` | Override Phoenix Grove base URL (default: `https://api.pgsgrove.com/v1`) |
