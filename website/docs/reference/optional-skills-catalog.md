...
| [**image-recognition**](/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-image-recognition) | View images natively and diagnose vision path issues. |
