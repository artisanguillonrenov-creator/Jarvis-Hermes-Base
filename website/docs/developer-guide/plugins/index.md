...
| [`on_turn_interrupted`](/user-guide/features/hooks#on_turn_interrupted) | Once per interrupted turn (`/stop`, mid-turn interrupt, preempting message) | `session_id: str, task_id: str, turn_id: str, user_message: str, assistant_response: str, conversation_history: list, interrupt_message: str, turn_exit_reason: str, model: str, platform: str` | ignored |
