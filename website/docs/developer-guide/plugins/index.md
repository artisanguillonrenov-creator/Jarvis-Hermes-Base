...
| [`gateway_platform_event`](/user-guide/features/hooks#gateway_platform_event) | An authorized platform-native event is normalized at the gateway boundary (Telegram reactions, edits, inbound messages currently) | `platform: str, event_type: str, payload: dict` | ignored |
