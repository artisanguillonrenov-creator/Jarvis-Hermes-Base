...
For deeper, persistent memory that goes beyond MEMORY.md and USER.md, Hermes ships with external memory provider plugins — including Honcho, OpenViking, Mem0, Hindsight, Holographic, RetainDB, ByteRover, Supermemory, and Memori. Community providers such as PLUR can also be installed separately.
