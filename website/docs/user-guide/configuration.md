...
```yaml
tts:
  provider: "edge"              # "edge" | "elevenlabs" | "openai" | "minimax" | "mistral" | "gemini" | "xai" | "neutts" | "kittentts" | "piper" | "deepinfra" | "mittwald"
...
| `mittwald` | `prompt` | OpenAI-compatible path, forwarded unchanged |
