---
title: "Multi Agent Pr Convergence — Converge multi-agent code work into a verified PR"
sidebar_label: "Multi Agent Pr Convergence"
...
Converge multi-agent code work into a verified PR.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/autonomous-ai-agents/multi-agent-pr-convergence` |
| Path | `optional-skills/autonomous-ai-agents/multi-agent-pr-convergence` |
| Version | `0.1.0` |
| Author | Herin Yudha Pratama (hrnbld), Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Multi-Agent`, `Pull-Request`, `Orchestration`, `Evidence` |
| Related skills | [`merge-reconciler`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-merge-reconciler), [`hermes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) |
