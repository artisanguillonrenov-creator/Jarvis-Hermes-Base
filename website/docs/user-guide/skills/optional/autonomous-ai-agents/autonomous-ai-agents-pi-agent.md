---
title: "Pi Agent — Delegate coding to the Pi terminal coding agent CLI"
sidebar_label: "Pi Agent"
...
Delegate coding to the Pi terminal coding agent CLI.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/autonomous-ai-agents/pi-agent` |
| Path | `optional-skills/autonomous-ai-agents/pi-agent` |
| Version | `1.0.0` |
