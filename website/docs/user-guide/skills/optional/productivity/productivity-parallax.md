---
title: "Parallax — Find upstream causes before choosing an intervention"
...
Find upstream causes before choosing an intervention.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/productivity/parallax` |
| Path | `optional-skills/productivity/parallax` |
| Version | `0.1.0` |
...
| Related skills | [`creative-ideation`](/docs/user-guide/skills/optional/creative/creative-creative-ideation), [`decision-questionnaire`](/docs/user-guide/skills/optional/productivity/productivity-decision-questionnaire) |
