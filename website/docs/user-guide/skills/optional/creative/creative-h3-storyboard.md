---
title: "H3 Storyboard — MiniMax H3 shot breakdown and facial performance direction"
sidebar_label: "H3 Storyboard"
...
MiniMax H3 shot breakdown and facial performance direction.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/creative/h3-storyboard` |
| Path | `optional-skills/creative/h3-storyboard` |
| Version | `1.0.0` |
| Author | Ray (phileiny), ported by Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `video-generation`, `minimax-h3`, `storyboard`, `directing`, `creative` |
| Related skills | [`kanban-video-orchestrator`](/docs/user-guide/skills/optional/creative/creative-kanban-video-orchestrator), [`hyperframes`](/docs/user-guide/skills/optional/creative/creative-hyperframes), [`comfyui`](/docs/user-guide/skills/optional/creative/creative-comfyui) |
