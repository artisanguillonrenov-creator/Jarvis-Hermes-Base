---
title: "Social Har Api Connectivity — Capture a social login session via CDP (authorized only)"
...
Capture a social login session via CDP (authorized only).

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/social-media/social-har-api-connectivity` |
| Path | `optional-skills/social-media/social-har-api-connectivity` |
| Version | `1.1.0` |
