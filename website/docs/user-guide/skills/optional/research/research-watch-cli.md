---
title: "Watch Cli — Turn a video URL into still frames and a transcript"
sidebar_label: "Watch Cli"
...
Turn a video URL into still frames and a transcript.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/research/watch-cli` |
| Path | `optional-skills/research/watch-cli` |
| Version | `1.0.0` |
| Author | Son Piaz (sonpiaz) |
| License | MIT |
| Platforms | linux, macos |
| Tags | `Video`, `Transcription`, `Frames`, `Research`, `Multimedia` |
| Related skills | [`youtube-content`](/docs/user-guide/skills/bundled/media/media-youtube-content), [`whisper`](/docs/user-guide/skills/optional/mlops/mlops-whisper) |
