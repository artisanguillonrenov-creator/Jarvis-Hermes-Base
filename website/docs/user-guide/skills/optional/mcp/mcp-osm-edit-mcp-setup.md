---
title: "Osm Edit Mcp Setup — Configure and verify OSM Edit MCP safely"
sidebar_label: "Osm Edit Mcp Setup"
...
Configure and verify OSM Edit MCP safely.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/mcp/osm-edit-mcp-setup` |
| Path | `optional-skills/mcp/osm-edit-mcp-setup` |
| Version | `0.1.0` |
