...
const tr: BotsMessages = {
  roster: {
    search: 'Botlar ve grup sohbetlerinde ara',
    searchPlaceholder: 'Botlar ve grup sohbetlerinde ara…',
    newBotOrGroup: 'Yeni bot veya grup sohbeti',
    groupChats: 'Grup sohbetleri',
    emptyTitle: 'Henüz bot yok',
    emptyDesc: 'İlk botunuzu oluşturun.',
    noMatchQuery: query => `“${query}” ile eşleşen bot veya grup sohbeti yok`,
    noMatchQueryOn: (query, gateway) => `${gateway} üzerinde “${query}” ile eşleşen bot veya grup sohbeti yok`,
    noMatchFiltersOn: gateway => `${gateway} üzerinde bu filtrelerle eşleşen bot veya grup sohbeti yok`,
    noMatchFilters: 'Bu filtrelerle eşleşen bot veya grup sohbeti yok.',
    clearFilters: 'Filtreleri temizle',
    allHidden: 'Tüm botlar gizli',
    allHiddenDesc: 'Çalışmaya ve geçmişlerini tutmaya devam ederler.',
    showHidden: 'Gizli botları göster',
    noHiddenMatch: 'Bu filtrelerle eşleşen gizli bot yok.',
    hiddenFromRoster: 'Listede gizli',
    pinned: 'Sabitlendi',
    needsAttention: 'ilgi gerekiyor',
    needsInput: 'Girdinizi bekliyor',
    botsAndGroups: 'Botlar ve grup sohbetleri',
    botsOnly: 'Yalnızca botlar',
    groupsOnly: 'Yalnızca grup sohbetleri',
    anyActivity: 'Herhangi bir etkinlik',
    activeNow: 'Şimdi etkin',
    recentlyActive: 'Yakın zamanda etkin',
    older: 'Daha eski',
    gatewayRemoved: 'Ağ geçidi kaldırıldı',
    onDemand: 'İsteğe bağlı',
    ready: 'Hazır',
    statusUnknown: 'Durum bilinmiyor',
    unavailable: 'Kullanılamıyor',
    retryNow: 'Şimdi yeniden dene',
    rosterUnavailable: reason =>
      `Liste kullanılamıyor: ${reason}. Ağ geçidiniz profiles.list özelliğinden eskiyse Hermes’i güncelleyin ve ağ geçidini yeniden başlatın.`,
    waitingForGateway:
      'Ağ geçidi bağlantısı bekleniyor… (uzak ağ geçitleri birkaç saniye sürebilir; otomatik yeniden denenir)'
  },
  sections: {
    newSection: 'Yeni bölüm',
    newTitle: 'Yeni bölüm',
    renameTitle: 'Bölümü yeniden adlandır',
    nameLabel: 'Bölüm adı',
    namePlaceholder: 'ör. Müşteriler',
    create: 'Oluştur',
    rename: 'Yeniden adlandır…',
    moveUp: 'Yukarı taşı',
    moveDown: 'Aşağı taşı',
    unassigned: 'Atanmamış',
    options: name => `${name} bölümü seçenekleri`,
    headingTip: 'Botları buraya bırakın · yeniden adlandırmak için çift tıklayın',
    emptyHint: 'Botları buraya sürükleyin',
    moveTo: 'Bölüme taşı',
    newSectionEllipsis: 'Yeni bölüm…',
    removeFromSection: 'Bölümden kaldır',
    deleted: (name, count) =>
      count === 0 ? `“${name}” silindi` : `“${name}” silindi — ${count} bot Atanmamış bölümüne taşındı`,
    undo: 'Geri al'
  },
  bot: {
    newTitle: 'Yeni bot',
    ...
    editMenu: 'Düzenle…',
    helpPromptPlaceholder: 'Bu bot hangi konuda yardımcı olsun?',
    descriptionHint: 'Ad ve açıklamadan oluşturmak için boş bırakın.',
    newChatWith: 'Bu botla yeni sohbet',
    openBotChat: 'Bot Sohbeti’ni aç',
    duplicate: 'Çoğalt',
    duplicateFailed: 'Çoğaltma başarısız oldu',
    deleteTitle: 'Bot ve profil silinsin mi?',
    removeFromAllGroups: 'Tüm gruplardan kaldır',
    createFirstHint: 'Botlar panelini açın ve “Yeni Bot” seçeneğine tıklayın.',
    createFailed: 'Profil henüz oluşturulamadı',
    advanced: 'Gelişmiş',
    advancedHint: 'Gelişmiş — model, beceriler, araç setleri, SOUL.md',
    advancedFailed: 'Gelişmiş yapılandırma başarısız oldu',
    openAnotherChatUnsupported: 'Başka bir Bot Sohbeti açmak için Hermes Masaüstü’nü güncelleyin.',
    remoteConnectionsUnsupported: 'Diğer bağlantılardaki botlarla sohbet etmek için Hermes Masaüstü’nü güncelleyin.',
    openNeedsUpdateTitle: 'Bu bot eski bir Hermes sürümünde çalışıyor',
    openNeedsUpdateMessage: connectionLabel => `${connectionLabel} bağlantısını güncelleyin ve tekrar deneyin.`,
    openUnreachableTitle: 'Hermes bu botun çalıştığı bilgisayara ulaşamadı',
    openUnreachableMessage: 'Bilgisayarın çevrimiçi olduğunu kontrol edip tekrar deneyin.',
    openChatFailedTitle: botName => `${botName} sohbeti açılamadı`,
    openChatFailedMessage: 'Lütfen tekrar deneyin.',
    openGateways: 'Ağ geçitlerini aç',
    chatEmpty: 'Başlamak için bir şey söyleyin.',
    kickoff: 'Merhaba, bana kendinden bahset!'
  },
  avatar: {
    classicShapes: 'Klasik şekiller',
    blobFromName: 'Damla yüz — botun adından oluşturulur',
    unlockFollowsName: 'Kilidi aç — yüz yeniden botun adını takip etsin',
    randomize: 'Rastgeleleştir',
    tabBot: 'Bot',
    tabGenerate: 'Oluştur',
    upload: 'Yükle',
    tabPet: 'Evcil hayvan',
    removeImage: 'Görseli kaldır — şekli kullan',
    removeBackToShape: 'Kaldır — şekil avatara dön',
    describePlaceholder: 'Avatarını tanımla…',
    describeHint: 'Ad/başlık/açıklama ve ajan mesajlaşma listesinden otomatik oluşturmak için boş bırakın.',
    matchTheName: 'Adıyla eşleştir',
    pickPet: 'Bu botun profil resmi olarak bir evcil hayvan seçin.',
    petLoadFailed: 'Evcil hayvan yüklenemedi — başka birini deneyin.',
    imageTooLarge: 'Görsel çok büyük (en fazla 15 MB).',
    generationFailed: 'Avatar oluşturma başarısız oldu',
    savedLocally: 'Görünüm yerel olarak kaydedildi; uzak kalıcılık başarısız oldu',
    savedLocallyDescriptionFailed: 'Görünüm yerel olarak kaydedildi; açıklama güncellemesi başarısız oldu',
    generate: 'Oluştur',
    generating: 'Oluşturuluyor…'
  },
  group: {
    newTitle: 'Yeni grup sohbeti',
    manageDesc: 'Bir bot birden fazla grup sohbetine katılabilir. Üyelikler tüm makinelerle eşitlenir.',
    manageTitle: 'Grupları yönet',
    settingsTitle: 'Grup ayarları',
    settingsDesc: 'Grubu yeniden adlandırın veya oda görseli belirleyin. Üyeler ve geçmiş korunur.',
    nameLabel: 'Grup adı',
    searchToAdd: 'Eklenecek botları ara',
    searchToAddPlaceholder: 'Eklenecek botları ara…',
    removeFromSelection: 'Seçimden kaldır',
    disbandTitle: 'Grup sohbeti dağıtılsın mı?',
    deleteTitle: 'Grup sohbeti silinsin mi?',
    deleteAction: 'Sil',
    composerPlaceholder: 'Bir şey söyleyin — bu gruptaki her bot odayı duyar.',
    slashCommandsUnsupported:
      'Grup sohbetlerinde eğik çizgi komutları desteklenmiyor. Kullanmak için botun bireysel sohbetini açın.',
    attachHint: 'Dosya ekleyin — yanıt veren her bot bunları görür',
    newThread: 'Yeni ileti dizisi',
    reply: 'Yanıtla',
    replyInThread: 'İleti dizisinde yanıtla',
    replyInThreadPlaceholder: 'İleti dizisinde yanıtla…',
    openThread: 'Bu ileti dizisini aç',
    collapseThread: 'İleti dizisini daralt',
    collapseThreadLabel: 'Bu ileti dizisini daralt',
    activity: 'Etkinlik',
    noActivityYet: 'Bu turda henüz etkinlik yok.',
    showActivity: 'Oda etkinliğini göster',
    hideActivity: 'Oda etkinliğini gizle',
    stop: 'Durdur',
    stopHint: 'Bu çalıştırmayı durdur — sıradaki üyeyi keser, kalanları bekletir',
    allHeldStatus: count => `Tüm ${count} bot duraklatıldı`,
    heldMembersStatus: members => `Duraklatıldı: ${members}`,
    holdReleaseHint: 'Duraklatılmış bir bottan bahsedin veya onları serbest bırakmak için @all resume gönderin.',
    needsYourInput: 'Bu grup sohbetindeki bir bot girdinizi bekliyor',
    noMembersToSend: group =>
      `${group} grubunda mesaj gönderilecek üye yok. Bir bot ekleyin veya üyeler hâlâ yükleniyorsa odayı yeniden açın.`,
    pictureGenerationFailed: 'Grup görseli oluşturma başarısız oldu',
    nameTaken: name => `“${name}” adlı bir grup zaten var.`,
    memberCount: count => `${count} bot`,
    settingsHint: group => `Grup ayarları — ${group} adını değiştirin veya oda görseli belirleyin`,
    settingsLabel: group => `${group} için grup ayarları`,
    disbandHint: group => `${group} grup sohbetini dağıt`,
    disbandLabel: group => `${group} grubunu dağıt`,
    disbandAction: 'Dağıt',
    disbanding: 'Dağıtılıyor…',
    disbandDone: 'Dağıtıldı',
    disbanded: group => `“${group}” dağıtıldı`,
    disbandDescPrefix: 'Bu işlem ',
    disbandDescSuffix: count =>
      ` grubunu ${count} bottan kaldırır ve paylaşılan oda günlüğünü temizler. Botlar ve grup başına oturumları korunur.`,
    stopped: group => `${group} durduruldu — kalan turlar siz sürdürünceye kadar bekletilir`,
    removeAttachment: 'Eki kaldır',
    threadFallback: 'İleti dizisi',
    replyCount: replies => `${replies} yanıt`,
    dropToThread: 'Bu ileti dizisi yanıtına eklemek için bırakın',
    dropToRoom: 'Eklemek için bırakın — yanıt veren her bot görür',
    waitingForAnswer: 'Yanıtınızı bekliyor…',
    memberThinking: name => `${name} düşünüyor…`,
    roomWorking: 'Oda çalışıyor…',
    messageRoom: group => `${group} grubuna mesaj gönder`,
    newThreadPlaceholder: group => `${group} içinde yeni ileti dizisi… (yönlendirmek için @ad, tümü için @everyone)`,
    everyoneMeta: 'Odadaki her bot',
    commandApproval: 'komut onayı',
    answerFailed: (handle, error) => `@${handle} kişisine yanıt gönderilemedi: ${error}`,
    wantsToRunCommand: handle => `@${handle} bir komut çalıştırmak istiyor:`,
    asks: handle => `@${handle} soruyor:`,
    answerTo: member => `@${member} kişisine yanıt ver`
  },
  tools: {
    skillsHub: 'Hermes Beceriler Merkezi',
    filterSkills: 'Becerileri filtrele…',
    searchHub: 'Merkezde ara (topluluk ve bilinen kaynaklar)…',
    noMcpServers: 'Yapılandırılmış veya katalogda bulunan MCP sunucusu yok.'
  },
  cron: {
    filterHint:
      'Bu profilde zamanlanmış işler var ancak hiçbiri bu bot için etiketlenmemiş. Burada göstermek için bir işi "[bot:<name>] …" olarak adlandırın veya aşağıdaki Cron bölümünde görüntüleyin.',
    needsRosterFirst: 'Bu botun önce listede görünmesi gerekir.',
    staleNotice: 'Zamanlanmış işler yenilenemedi. Elde olan son liste gösteriliyor.',
    readFailure: 'Liste hâlâ mevcut olabilir — bu silme değil, okuma hatasıydı.',
    createDesc: bot =>
      `Tekrarlayan bir görev ${bot} için zamanlamaya göre çalışır. Çalıştırmalar kendi sohbet geçmişine düşer.`,
    instruction: 'Talimat',
    whenToRun: 'Çalışma zamanı',
    dayOfMonth: 'Ayın günü',
    sendResultsTo: 'Sonuçları gönder',
    runHistoryOnly: 'Yalnızca çalışma geçmişi',
    botChatTarget: bot => `${bot} sohbeti (bot yanıtlar)`,
    continuity: 'Süreklilik: her çalıştırma öncekinin çıktısını görür (yineleneni önler, kaldığı yerden sürdürür)',
    onceIn: when => `Bir kez (${when})`,
    everyNDays: days => `${days} günde bir`,
    everyNHours: hours => `${hours} saatte bir`,
    everyNMinutes: minutes => `${minutes} dakikada bir`,
    freqOnce: 'Bir kez, şu süre sonra…',
    freqHourly: 'Her saat',
    freqDaily: 'Her gün',
    ...
    freqMonthly: 'Her ay',
    freqInterval: 'Aralık',
    freqAdvanced: 'Gelişmiş…',
    unitMinutes: 'dakika',
    unitHours: 'saat',
    unitDays: 'gün',
    runsOnce: (count, unit) => `Bir kez, ${count} ${unit} sonra çalışır`,
    runsHourly: 'Her saatin başında çalışır',
    runsDaily: time => `Her gün ${time} saatinde çalışır`,
    runsWeekdays: time => `Pazartesi–Cuma günleri ${time} saatinde çalışır`,
    runsWeekly: (day, time) => `Her ${day} günü ${time} saatinde çalışır`,
    runsMonthly: (day, time) => `Her ayın ${day}. günü ${time} saatinde çalışır`,
    runsInterval: (count, unit) => `Her ${count} ${unit} çalışır`,
    runsRaw: 'Ham zamanlama — her Nm/Nh/Nd veya 5 alanlı cron',
    timesTotal: count => `, toplam ${count} kez`
  }
}
...
export const BOTS_LOCALES: PluginLocaleBundles = { en, ja, zh, 'zh-hant': zhHant, tr }
