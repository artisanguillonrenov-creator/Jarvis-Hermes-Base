...
const tr: KanbanMessages = {
  nav: 'Kanban',
  openBoard: 'Kanban: Panoyu aç',
  newTaskCommand: 'Kanban: Yeni görev',
  countTip: (running, ready) => `Kanban — ${running} çalışıyor, ${ready} hazır`,
  col: {
    triage: { label: 'Ön değerlendirme', help: 'Ham fikirler — bir ayrıntılandırıcı görev tanımını oluşturur.' },
    todo: { label: 'Yapılacak', help: 'Bağımlılıkları veya atanan profili bekliyor.' },
    scheduled: { label: 'Zamanlandı', help: 'Zamanlanmış saatin gelmesini bekliyor.' },
    ready: { label: 'Hazır', help: 'Bağımlılıklar tamam; bir profil atayın, dağıtıcı görevi çalıştırsın.' },
    running: { label: 'Çalışıyor', help: 'Bir çalışan sahiplendi — bir ajan üzerinde çalışıyor. Dağıtıcı ayarlar.' },
    blocked: { label: 'Engellendi', help: 'Çalışan insan girdisi bekliyor.' },
    review: { label: 'İnceleme', help: 'Bir inceleme ajanı işi denetliyor. Dağıtıcı ayarlar.' },
    done: { label: 'Tamamlandı', help: 'Tamamlandı; bağımlı alt görevler hazır olur.' },
    archived: { label: 'Arşivlendi', help: 'Varsayılan pano görünümünde gizlenir.' }
  },
  locked: {
    review: 'Bir inceleme ajanı kartı aldığında dağıtıcı İnceleme durumuna geçirir.',
    running: 'Bir çalışan kartı sahiplendiğinde dağıtıcı Çalışıyor durumuna geçirir.',
    scheduled: 'Zamanlandı durumunun bir uyandırma saati gerekir — ajanlar ayarlar; karta sürüklenemez.'
  },
  arcRunning: 'Bir ajan şu anda bunun üzerinde çalışıyor.',
  arcStale: 'Sahiplenildi ancak 2+ dakikadır çalışan sinyali yok — dağıtıcı görevi geri alacak.',
  title: 'Kanban',
  orchestrationSettings: 'Orkestrasyon ayarları',
  newTask: 'Yeni görev',
  filterCards: 'Kartları filtrele…',
  noMatch: 'Filtrelerle eşleşen görev yok',
  noTasks: 'Bu panoda görev yok',
  open: 'Aç',
  select: modifier => `Seç (${modifier}-tıklama)`,
  deselect: 'Seçimi kaldır',
  moveTo: label => `${label} durumuna taşı`,
  delete: 'Sil',
  reviewChecking: 'Bir inceleme ajanı tamamlanan işi denetliyor.',
  attachedTip: name => `${name} eklendi — dağıtıcı bunu sonraki turunda (≤1 dk.) devralacak.`,
  orchestratorTip: name => `${name} (orkestratör) bunu sonraki turda alır ve görevin tanımını yazar.`,
  autoAssignTip: name => `Sonraki dağıtım turunda “${name}” profiline (kanban.default_assignee) otomatik atanır.`,
  wontRun: 'çalışmaz',
  wontRunTip:
    'Hazır kartlar yalnızca bir profil atandığında çalışır. Kartı açıp bir sorumlu atayın veya orkestrasyon ayarlarında varsayılan sorumlu belirleyin.',
  noHeartbeat: 'çalışan sinyali yok',
  expand: label => `${label} bölümünü genişlet`,
  collapse: label => `${label} bölümünü daralt`,
  newTaskIn: label => `${label} içinde yeni görev`,
  empty: 'Boş',
  ...
  groupRunning: 'Çalışanları profile göre grupla',
  nSelected: n => `${n} seçildi`,
  moveToShort: 'Taşı',
  assign: 'Ata',
  unassignAction: 'Atamayı kaldır',
  archive: 'Arşivle',
  clearSelection: 'Seçimi temizle (Esc)',
  refused: 'reddedildi',
  bulkFailed: (failed, total, err) =>
    `${total} kartın ${failed} tanesi başarısız oldu — ${err}. Başarısız kartlar seçili kalır.`,
  titlePlaceholderTriage: 'Ham fikir — bir ayrıntılandırıcı bunu geliştirecek',
  titlePlaceholder: 'Başlık',
  descPlaceholder: 'Açıklama (isteğe bağlı)',
  priority: 'Öncelik',
  workspace: 'Çalışma alanı',
  boardDefaultSuffix: ' · pano varsayılanı',
  workspaceOverride: 'Çalışma alanı yolu (isteğe bağlı geçersiz kılma)',
  model: 'Model',
  modelInherit: 'Profil varsayılanı',
  modelClear: 'Model geçersiz kılmasını temizle',
  modelHint:
    'Bu görevi belirli bir model ve düşünme derinliğiyle çalıştırır. Boş bırakılırsa atanan profilin kendi ayarı kullanılır.',
  workspaceInherit: 'Pano proje dizinini devralır',
  workspaceInheritDir: dir => `${dir} dizinini devralmak için boş bırakın`,
  workspaceInheritGeneric: 'Pano proje dizinini devralmak için boş bırakın.',
  assignee: 'Sorumlu',
  defaultOption: name => `${name} (varsayılan)`,
  parkedOption: 'atanmamış (beklemede — çalışmaz)',
  skills: 'Beceriler (virgülle ayrılmış)',
  skillsPlaceholder: 'translation, github',
  parent: 'Üst görev (tamamlanana kadar engeller)',
  noParent: '— üst görev yok —',
  goalMode: 'Hedef modu (çalışan, bir değerlendirici tamamlandığını kabul edene kadar döner)',
  creating: 'Oluşturuluyor…',
  createTask: 'Görev oluştur',
  cancel: 'İptal',
  save: 'Kaydet',
  estimate: 'Tahmin',
  estimateEffort: 'Çabayı tahmin et',
  estimating: 'Tahmin ediliyor…',
  reEstimate: 'Yeniden tahmin et',
  makesModelCall: 'model çağrısı yapar',
  estimateTip: 'Yardımcı modelden kaba belirteç ve karmaşıklık tahmini alır — model çağrısı yapar.',
  estimateTipLong:
    'Belirteç ve karmaşıklığı tahmin etmek için hızlı bir yardımcı model çağrısı çalıştırır. Faturanız değil, yalnızca kaba bir rehberdir.',
  roughEstimate: 'Kaba tahmin',
  tokUnit: 'tok',
  couldNotEstimate: 'Tahmin edilemedi',
  complexity: { S: 'Küçük', M: 'Orta', L: 'Büyük' },
  introBody:
    'Kartları siz değil ajanlar çalıştırır. Bir kartı sorumlusuyla birlikte Hazır durumuna alın; bir ajan bir dakika içinde görevi alır. Sorumlu yoksa çalışma da yoktur. Ön değerlendirme: bir ajan önce fikri düzgün bir göreve dönüştürür. Yapılacak: diğer kartları bekler. Zamanlandı: zamanlayıcıyı bekler. Çalışıyor ve İnceleme: ajanların alanıdır, müdahale etmeyin. Engellendi: sizi bekliyor. Sonuçlar karta döner.',
  introGotIt: 'Anladım',
  evtCreated: (where, assignee) =>
    `oluşturuldu${where ? `: ${where}` : ''}${assignee ? ` · ${assignee} profiline atandı` : ''}`,
  evtMovedTo: col => `${col} durumuna taşındı`,
  evtParentReopened: parent => `${parent} üst görevi yeniden açıldı`,
  evtAssignedTo: assignee => `${assignee} profiline atandı`,
  evtUnassigned: 'atama kaldırıldı',
  evtCommentBy: author => `${author} tarafından yorum yapıldı`,
  evtClaimedReview: 'bir inceleme ajanı sahiplendi',
  evtClaimedWorker: 'bir çalışan sahiplendi',
  evtWorkerStarted: 'çalışan başladı',
  evtCompleted: 'tamamlandı',
  evtBlocked: 'engellendi — insan girdisi gerekiyor',
  evtUnblocked: col => `engel kaldırıldı${col ? ` → ${col}` : ' → Hazır'}`,
  evtReclaimed: 'geri alındı — kuyruğa döndürüldü',
  evtSpecified: 'görev tanımı ön değerlendirme ajanı tarafından yazıldı',
  evtPromoted: 'bağımlılıklar tamamlandı — Hazır durumuna alındı',
  evtScheduled: 'daha sonrası için zamanlandı',
  evtArchived: 'arşivlendi',
  evtReprioritized: priority => `öncelik ${priority} olarak ayarlandı`,
  someone: 'birisi',
  metaPriority: 'Öncelik',
  metaTenant: 'Kiracı',
  metaCreatedBy: 'Oluşturan',
  metaCreated: 'Oluşturulma',
  metaWorkerPid: 'Çalışan PID',
  readyUnassignedTitle: 'Hazır ancak atanmamış — bu kart asla çalışmaz.',
  readyUnassignedBody:
    'Dağıtıcı yalnızca sorumlusu olan Hazır kartları sahiplenir. Yukarıdaki Sorumlu alanından bir profil seçin (veya orkestrasyon ayarlarında varsayılan sorumlu belirleyin); kart bir dakika içinde çalışır.',
  diagnosticsN: n => `Tanılama · ${n}`,
  ...
  result: 'Sonuç',
  latestSummary: 'Son özet',
  dependencies: 'Bağımlılıklar',
  blockedBy: 'Engelleyen',
  blocks: 'Engelledikleri',
  comments: n => `Yorumlar · ${n}`,
  commentsHelpRunning:
    'Bu görev çalışıyor. Notunuz birkaç saniye içinde çalışanın mevcut turuna eklenir — engelleme/açma adımına gerek yoktur. “Notla yeniden kuyruğa al” ise görevi notunuz bağlamda olacak şekilde baştan başlatır.',
  commentsHelp:
    'Yorumlar görev iş parçacığına eklenir. Bir çalışan görevi aldığında bunları bağlamının parçası olarak okur.',
  send: 'Gönder',
  comment: 'Yorum',
  messageWorker: 'Çalışan ajana mesaj gönder…',
  addComment: 'Yorum ekle…',
  deliveredLive: 'Çalışan ajana birkaç saniye içinde iletildi.',
  requeueWithNote: 'Notla yeniden kuyruğa al',
  notePosted: 'Not gönderildi — çalışan yeniden kuyruğa alındı',
  activity: n => `Etkinlik · ${n}`,
  runs: n => `Çalıştırmalar · ${n}`,
  workerLog: 'Çalışan günlüğü',
  workerLogTail: 'Çalışan günlüğü · son satırlar',
  attachments: n => `Ekler · ${n}`,
  noAttachments: 'Henüz ek yok.',
  uploadAttachment: 'Ek yükle',
  taskActions: 'Görev işlemleri',
  copyTaskId: 'Görev kimliğini kopyala',
  copyTitle: 'Başlığı kopyala',
  copiedId: id => `${id} kopyalandı`,
  copiedTitle: 'Başlık kopyalandı',
  close: 'Kapat',
  working: 'çalışıyor',
  board: 'Pano',
  newBoard: 'Yeni pano',
  newBoardDots: 'Yeni pano…',
  exportDots: 'Dışa aktar…',
  importDots: 'İçe aktar…',
  renameDots: 'Yeniden adlandır…',
  settingsDots: 'Ayarlar…',
  exportBoardTitle: 'Panoyu dışa aktar…',
  importBoardTitle: 'Panoyu içe aktar…',
  boardExported: path => `Pano ${path} konumuna dışa aktarıldı`,
  boardImported: name => `${name} içe aktarıldı`,
  boardImportedAs: slug => `Bu ad kullanılıyor — ${slug} adıyla içe aktarıldı`,
  renameBoardTitle: 'Panoyu yeniden adlandır',
  deleteBoardTitle: name => `“${name}” silinsin mi?`,
  deleteBoardConfirm: 'Pano silinmez, arşivlenir — görevleri ve ekleri diskte kalır ve geri yüklenebilir.',
  boardArchived: path => `Pano ${path} konumuna arşivlendi`,
  boardSettingsFor: name => `Pano ayarları — ${name}`,
  name: 'Ad',
  boardNamePlaceholder: 'Pano adı',
  slug: slug => `kısa ad: ${slug}`,
  project: 'Proje',
  noProject: 'Proje yok (geçici alanlar)',
  projectHintPre:
    'Yeni görevler projenin deposunda çalışır (görev başına bir çalışma ağacı); her görev oluşturulurken çalışma alanını yine geçersiz kılabilir. Projeleri şununla yönetin: ',
  projectHintCmd: 'hermes project',
  createBoard: 'Pano oluştur',
  orchestratorProfile: 'Orkestratör profili',
  defaultAssignee: 'Varsayılan sorumlu',
  defaultParen: '(varsayılan)',
  autoDecompose: 'Ön değerlendirme görevlerini otomatik ayrıştır',
  profileDescriptions: 'Profil açıklamaları',
  profileDescriptionsHint:
    'Açıklamalar ayrıştırıcının yönlendirmesine yardımcı olur. Yardımcı modelle otomatik oluşturabilir veya kendiniz yazabilirsiniz.',
  profileGoodAt: 'Bu profil hangi konuda iyi?',
  auto: 'Otomatik',
  notify: {
    completedTitle: 'Görev tamamlandı',
    blockedTitle: 'Görev engellendi — girdiniz gerekiyor',
    blockLoopTitle: 'Görev ön değerlendirmeye yönlendirildi — karar gerekiyor',
    gaveUpTitle: 'Görev vazgeçti',
    gaveUpBody: 'Hermes bu görevi tamamlayamadı. Nedenini görmek ve yeniden atamak için Kanban’ı açın.',
    crashedTitle: 'Çalışan çöktü — yeniden denenecek',
    timedOutTitle: 'Görev zaman aşımına uğradı — yeniden denenecek',
    openKanban: 'Kanban’ı aç',
    artifacts: n => `${n} çıktı`
  }
}
...
export const KANBAN_LOCALES: PluginLocaleBundles = { en, ja, zh, 'zh-hant': zhHant, tr }
