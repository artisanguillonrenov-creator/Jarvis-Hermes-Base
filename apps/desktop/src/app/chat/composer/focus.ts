...
/** Start or stop dictation on ONE composer — the `composer.dictate` hotkey.
 *  Like the voice toggle, this targets the active visible composer so hidden
 *  keep-alive tabs never start recording together. */
