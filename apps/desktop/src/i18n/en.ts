...
export const en: Translations = {
  ...
  composer: {
    ...
    themeTryPost: '.',
    attachLabel: 'Attach',
    addFilesAndActions: 'Add files and actions',
  ...
  automationComposer: {
    kickoffFailure: 'Goal saved, but its first turn could not start. Pause and resume it from its card.',
    manageExisting: 'Manage existing',
    noSession: 'Start a conversation first, then create an automation here.',
    unavailable: 'Automation controls are unavailable. Check the connection and refresh.',
    advanced: 'Advanced',
    ...
    goalPromptLabel: 'Goal prompt',
    goalPromptPlaceholder: 'What should Hermes work toward?',
    goalCriteriaLabel: 'Completion criteria',
    goalCriteriaPlaceholder: 'A testable condition for done',
    addCriterion: 'Add criterion',
    removeCriterion: index => `Remove criterion ${index}`,
    maxTurnsLabel: 'Max continuation turns',
    maxTurnsOptional: 'optional',
    loopPromptLabel: 'Loop prompt',
    ...
    stopConditionOptional: 'optional',
    stopConditionPlaceholder: 'e.g. "the build is green"',
    heartbeatPromptLabel: 'Heartbeat prompt',
    heartbeatPromptPlaceholder: 'What should Hermes check on every heartbeat?',
    ...
    firstRunGoal: 'Work starts immediately — Hermes begins with your goal on the next turn.',
    firstRunLoop: 'The loop fires its first tick now, then again on the interval.',
    firstRunHeartbeat: 'The first heartbeat fires after one interval, then repeats on that cadence.',
    idleLoop: 'The loop only runs while this conversation is open and idle.',
    idleHeartbeat: 'Heartbeats only re-enter this session when it is idle.',
    sessionScope: title => `Runs in this conversation: ${title}`,
