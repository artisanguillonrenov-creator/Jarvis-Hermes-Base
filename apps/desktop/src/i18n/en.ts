...
export const en: Translations = {
  ...
  composer: {
    ...
    queueDelete: 'Delete',
    schedule: 'Schedule',
    scheduleTitle: 'Schedule this message',
    scheduleDue: 'Send at',
    scheduleConfirm: 'Schedule message',
    scheduleInvalid: 'Pick a time in the future',
    scheduled: (count: number) => `${count} Scheduled`,
    scheduledCancel: 'Cancel',
    scheduledCancelFailed: 'Could not cancel the scheduled message',
    scheduledSendFailed: 'Could not schedule the message',
    queueResume: 'Resume',
