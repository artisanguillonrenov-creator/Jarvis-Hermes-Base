...
export const en: Translations = {
  ...
  composer: {
    ...
    voiceEngineGeminiLive: 'Gemini Live (Multimodal WebSocket, delegates to Hermes)',
    voiceEngineGeminiLiveNeedsKey: 'Configure Google / Gemini API key',
    ...
    voiceEngineGeminiLiveShort: 'Gemini Live',
