...
export const en: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      toggleAccountUsage: 'Account usage',
      ...
      accountUsageLeft: remaining => `${remaining}% left`,
      accountUsagePanel: {
        openUsageSettings: 'Open usage settings',
        plan: plan => `${plan} plan`,
        refresh: 'Refresh',
        remaining: remaining => `${remaining}% remaining`,
        resets: time => `resets ${time}`,
        sessionLine: (input, output, total) => `${input} in · ${output} out · ${total} total`,
