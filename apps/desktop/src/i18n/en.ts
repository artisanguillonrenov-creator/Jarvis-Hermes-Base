...
export const en: Translations = {
  ...
  statusStack: {
    ...
    control: {
      ...
      editHeartbeatDescription: 'Change the message, how often it fires, or both.',
      heartbeatMessageLabel: 'Message',
      heartbeatFrequencyLabel: 'Frequency',
      heartbeatFrequencyPlaceholder: 'e.g. 10m',
