...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      tabStripNever: 'Never',
      paneDistributionTitle: 'Pane Distribution',
      paneDistributionDesc: 'Choose how structural pane additions and moves distribute the directly affected split. Manual sash resizing is preserved.',
      paneDistributionPreserve: 'Preserve',
      paneDistributionEqualFlex: 'Equal flex panes',
      paneDistributionEqualAll: 'Always equal',
      paneDistributionConfirmTitle: 'Redistribute existing panes?',
      paneDistributionConfirmDesc: 'This changes the weights of eligible panes in your current layout. Fixed, hidden, and minimized panes keep their constraints.',
      paneDistributionApplyExisting: 'Redistribute existing',
      paneDistributionFutureOnly: 'Only future changes',
      paneDistributionCancel: 'Cancel',
