...
export const en: Translations = {
  ...
  commandCenter: {
    ...
    stopGatewayConfirm: 'Stop the messaging gateway? Bots stop responding until it is started again.',
    gatewayActionPending: 'Another system action is still running',
