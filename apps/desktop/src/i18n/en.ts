...
export const en: Translations = {
  ...
  settings: {
    ...
    mcp: {
      ...
      discoveryTitle: 'Available on this gateway',
      discoveryFind: 'Find MCP servers',
      discoveryHint: 'Search known client configs and local listening ports. No programs are started during discovery.',
      discoverySearching: 'Looking for MCP servers…',
      discoveryEmpty: 'No additional MCP servers found. Custom paths and authenticated endpoints may need manual setup.',
      discoveryTarget: name => `Enable for ${name}`,
