...
export const en: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      toggleStreamTps: 'Live streaming speed',
      toggleTokenCounters: 'Token counters',
      ...
      streamTpsTitle: 'Output tokens per second for the current turn, updated live while streaming',
      tokenCountersTitle: 'Tokens used this turn — ↑ input ↓ output',
      agents: 'Agents',
