...
export const id = defineLocale({
  ...
  titlebar: {
    ...
    resetHudLayout: 'Reset ukuran dan posisi HUD',
  ...
  keybinds: {
    ...
    actions: {
      ...
      'view.selectionToComposer': 'Kirim seleksi ke composer',
  ...
  settings: {
    ...
    model: {
      ...
      tasks: {
        ...
        review: { label: 'Review', hint: 'Reviewer subagent /review' },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        label: 'Gunakan Profile Browser Asli Saya',
        description:
          "Menyalin login dan cookies browser default Anda ke snapshot terkelola yang dipakai agen buat browsing. Profile live Anda tidak pernah dibuka langsung. Berlaku buat session baru.",
        enabledTitle: 'Browsing real-profile aktif',
        enabledMessage: 'Session baru akan browsing dengan snapshot dari profile browser default Anda.',
        disabledTitle: 'Browsing real-profile nonaktif',
        disabledMessage: 'Snapshot profile akan dihapus; session baru pakai browser bersih.',
        failedSave: 'Tidak bisa menyimpan pengaturan real-profile'
      }
    }
  },
