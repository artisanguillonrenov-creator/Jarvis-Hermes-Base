...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    mcp: {
      ...
      discoveryTitle: '此閘道上可用的伺服器',
      discoveryFind: '尋找 MCP 伺服器',
      discoveryHint: '搜尋已知用戶端設定和本機監聽連接埠。探索過程中不會啟動程式。',
      discoverySearching: '正在尋找 MCP 伺服器…',
      discoveryEmpty: '未找到其他 MCP 伺服器。自訂路徑和需要驗證的端點可能需要手動設定。',
      discoveryTarget: name => `為 ${name} 啟用`,
      newServer: '新伺服器',
      reload: '重新載入 MCP',
      reloading: '重新載入中...',
