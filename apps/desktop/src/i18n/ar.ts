...
export const ar = defineLocale({
  ...
  settings: {
    ...
    sessions: {
      ...
      sidebarOpenInNewTabTitle: 'فتح محادثات الشريط الجانبي في علامات تبويب جديدة',
      sidebarOpenInNewTabDesc:
        'النقر العادي في الشريط الجانبي يفتح المحادثة أو يركّزها في علامة تبويب. يظل Cmd/Ctrl+نقر متاحاً لفتح علامة تبويب عندما يكون هذا الخيار معطلاً.',
