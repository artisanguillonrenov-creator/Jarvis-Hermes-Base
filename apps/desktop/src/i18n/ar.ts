...
export const ar = defineLocale({
  ...
  composer: {
    ...
    pasteImage: 'لصق صورة',
    url: 'رابط',
    promptTemplates: 'قوالب الموجّهات…',
    tipPre: 'نصيحة: اكتب ',
    tipPost: ' للإشارة إلى الملفات ضمن النص.',
    templatesTitle: 'قوالب الموجّهات',
    templatesDesc: 'اختر موجّهًا أوليًا لإدراجه في المحرّر.',
    templateAdd: 'إضافة قالب',
    templateEdit: 'تحرير',
    templateDelete: 'حذف',
    templateMoveUp: 'تحريك لأعلى',
    templateMoveDown: 'تحريك لأسفل',
    templateReset: 'استعادة الافتراضي',
    templateResetConfirm: 'استعادة جميع القوالب إلى الإعدادات الافتراضية الثلاثة؟ سيتم فقدان قوالبك المخصصة.',
    templateLabelPlaceholder: 'التسمية',
    templateDescPlaceholder: 'الوصف (اختياري)',
    templateTextPlaceholder: 'نص الموجّه',
    templateSave: 'حفظ',
    templateCancel: 'إلغاء',
    templateEmpty: 'لا توجد قوالب بعد. أضف واحدًا للبدء.',
    templateConfirmDelete: 'حذف هذا القالب؟',
    dropFiles: 'أفلت الملفات للإرفاق',
    dropSession: 'أفلت الجلسة للفتح',
    templates: {
      codeReview: {
        label: 'مراجعة الكود',
        description: 'تحقق من التغييرات الأخيرة للانحدارات والحالات الحدية غير المختبرة.',
        text: 'راجع الكود الذي شاركته. أشر إلى أي أخطاء أو انحدارات أو اختبارات مفقودة أو أنماط خطرة — مع أرقام الأسطر واقتراحات الإصلاح.'
      },
      implementationPlan: {
        label: 'خطة التنفيذ',
        description: 'ضع خطة خطوة بخطوة قبل كتابة أي كود.',
        text: 'قبل كتابة الكود، حدد خطوات التنفيذ لهذه المهمة. اذكر الملفات التي ستغيرها والنهج لكل منها وأي مخاطر أو مفاضلات.'
      },
      explainThis: {
        label: 'اشرح هذا',
        description: 'احصل على شرح خطوة بخطوة لكيفية عمل الكود.',
        text: 'اشرح لي كيف يعمل هذا الكود خطوة بخطوة. وضح القرارات التصميمية الرئيسية وأشر إلى أهم الملفات والدوال.'
      }
    }
  },
  statusStack: {
