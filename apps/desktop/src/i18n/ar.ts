...
export const ar = defineLocale({
  ...
  composer: {
    ...
    voiceControls: 'صوت',
    voiceEngine: 'محرك الدردشة الصوتية',
    voiceEngineChained: 'تحويل الكلام إلى نص + صوت Hermes',
    voiceEngineLive: 'GPT-Live (ثنائي الاتجاه بالكامل، يفوّض إلى Hermes)',
    voiceEngineLiveNeedsKey: 'يتطلب مفتاح API من OpenAI',
    voiceEngineGrok: 'Grok Live (ثنائي الاتجاه بالكامل، يفوّض إلى Hermes)',
    voiceEngineGrokNeedsKey: 'يتطلب تسجيل الدخول إلى SuperGrok أو مفتاح API من xAI',
    voiceEngineChangeFailed: 'تعذّر تغيير محرك الدردشة الصوتية',
    voiceEngineChainedShort: 'تحويل الكلام إلى نص',
