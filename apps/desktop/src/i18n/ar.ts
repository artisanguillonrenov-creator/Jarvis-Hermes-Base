...
export const ar = defineLocale({
  ...
  preview: {
    ...
    jumpToChange: 'التغيير',
    jumpToChangeTitle: 'انتقل إلى أول سطر تغير منذ آخر تحديث',
    backToReading: 'العودة إلى موضع القراءة',
    noChangesSinceOpen: 'لا تغييرات منذ الفتح',
    source: 'المصدر',
