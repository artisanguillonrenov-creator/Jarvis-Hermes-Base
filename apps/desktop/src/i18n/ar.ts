...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      trajectoryCollapsedTitle: 'طي مسار التنفيذ في ملخص',
      trajectoryCollapsedDesc: 'عند بدء الرد النهائي، اطوِ التفكير وخطوات الأدوات في سطر «اكتملت N خطوات».',
  ...
  assistant: {
    thread: {
      ...
      completedSteps: count => `اكتملت ${count} خطوات`,
      completedStepsIn: (count, duration) => `اكتملت ${count} خطوات في ${duration}`,
