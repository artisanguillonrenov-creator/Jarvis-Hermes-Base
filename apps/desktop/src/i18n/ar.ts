...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      linkOpenTitle: 'فتح الروابط',
      linkOpenDesc:
        'أين يُفتح رابط الويب عند النقر العادي. داخل التطبيق يستخدم لوحة المعاينة؛ الخارجي يستخدم متصفح النظام. ⌘/Ctrl والنقر الأوسط يفتحان دائماً خارجياً.',
      linkOpenInApp: 'داخل التطبيق',
      linkOpenExternal: 'خارجي',
