...
export const ar = defineLocale({
  ...
  settings: {
    ...
    mcp: {
      ...
      discoveryTitle: 'متاح على هذه البوابة',
      discoveryFind: 'البحث عن خوادم MCP',
      discoveryHint: 'البحث في إعدادات العملاء المعروفة ومنافذ الاستماع المحلية. لا يتم تشغيل برامج أثناء البحث.',
      discoverySearching: 'جارٍ البحث عن خوادم MCP…',
      discoveryEmpty: 'لم يتم العثور على خوادم MCP إضافية. قد تتطلب المسارات المخصصة ونقاط الاتصال المحمية إعدادًا يدويًا.',
      discoveryTarget: name => `تفعيل لـ ${name}`,
      newServer: 'خادم جديد',
