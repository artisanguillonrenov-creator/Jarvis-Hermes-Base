...
export const ar = defineLocale({
  ...
  commandCenter: {
    ...
    startGateway: 'تشغيل البوابة',
    stopGateway: 'إيقاف البوابة',
    stopGatewayConfirm: 'هل تريد إيقاف بوابة المراسلة؟ ستتوقف الروبوتات عن الاستجابة حتى تشغيلها مرة أخرى.',
    gatewayActionPending: 'لا يزال هناك إجراء نظام آخر قيد التنفيذ',
