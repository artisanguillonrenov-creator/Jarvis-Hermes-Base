...
export const zh = defineLocale({
  ...
  automationComposer: {
    kickoffFailure: '目标已保存，但无法启动首轮。请在卡片中暂停后再恢复。',
    manageExisting: '管理现有自动化',
    noSession: '请先开始对话，然后在此创建自动化。',
    unavailable: '自动化控件不可用。请检查连接并刷新。',
    advanced: '高级',
    title: '创建自动化',
    editTitle: '编辑自动化',
    goalLabel: '目标',
    loopLabel: '循环',
    heartbeatLabel: '心跳',
    goalPromptLabel: '目标提示',
    goalPromptPlaceholder: 'Hermes 应该朝什么方向努力？',
    goalCriteriaLabel: '完成标准',
    goalCriteriaPlaceholder: '一个可检验的完成条件',
    addCriterion: '添加标准',
    removeCriterion: index => `移除标准 ${index}`,
    maxTurnsLabel: '最大继续轮数',
    maxTurnsOptional: '可选',
    loopPromptLabel: '循环提示',
    ...
    stopConditionOptional: '可选',
    stopConditionPlaceholder: '例如「构建通过」',
    heartbeatPromptLabel: '心跳提示',
    heartbeatPromptPlaceholder: 'Hermes 每次心跳应该检查什么？',
    startGoal: '开始目标',
    startLoop: '开始循环',
    ...
    saveLoop: '保存循环',
    saveHeartbeat: '保存心跳',
    firstRunGoal: '立即开始工作——Hermes 将在下一轮开始执行你的目标。',
    firstRunLoop: '循环现在触发第一次，之后按间隔重复。',
    firstRunHeartbeat: '第一次心跳在间隔之后触发，然后按该节奏重复。',
    idleLoop: '循环只会在本会话打开且空闲时运行。',
    idleHeartbeat: '心跳只会在本会话空闲时重新进入。',
    sessionScope: title => `在此会话中运行：${title}`,
    cronLink: '改为创建定时任务',
