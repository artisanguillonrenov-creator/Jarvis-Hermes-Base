...
export const zh = defineLocale({
  ...
  settings: {
    ...
    mcp: {
      ...
      discoveryTitle: '此网关上可用的服务器',
      discoveryFind: '查找 MCP 服务器',
      discoveryHint: '搜索已知客户端配置和本地监听端口。发现过程中不会启动程序。',
      discoverySearching: '正在查找 MCP 服务器…',
      discoveryEmpty: '未找到其他 MCP 服务器。自定义路径和需要身份验证的端点可能需要手动设置。',
      discoveryTarget: name => `为 ${name} 启用`,
      newServer: '新服务器',
      reload: '重新加载 MCP',
      reloading: '重新加载中...',
