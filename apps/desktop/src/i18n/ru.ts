...
export const ru = defineLocale({
  ...
  composer: {
    ...
    voiceEngineChained: 'Речь в текст + голос Hermes',
    voiceEngineLive: 'GPT-Live (полный дуплекс, делегирует Hermes)',
    voiceEngineLiveNeedsKey: 'Требуется ключ API OpenAI',
    voiceEngineGrok: 'Grok Live (полный дуплекс, делегирует Hermes)',
    voiceEngineGrokNeedsKey: 'Требуется вход в SuperGrok или ключ API xAI',
    voiceEngineChangeFailed: 'Не удалось изменить движок голосового чата',
