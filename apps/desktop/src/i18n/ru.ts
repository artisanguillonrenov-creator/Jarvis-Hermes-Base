...
export const ru = defineLocale({
  ...
  settings: {
    ...
    notifications: {
      ...
      enableAppSounds: 'Включить звуки и тактильную отдачу приложения',
      enableAppSoundsDesc: 'Управляет звуками завершения, размышления и пробуждения отдельно от системных уведомлений.',
