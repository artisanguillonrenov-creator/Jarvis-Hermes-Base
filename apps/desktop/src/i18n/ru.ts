...
export const ru = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      toggleStreamTps: 'Скорость потоковой передачи',
      toggleTokenCounters: 'Счётчики токенов',
      ...
      streamTpsTitle: 'Выходных токенов в секунду для текущего хода, обновляется в реальном времени во время потоковой передачи',
      tokenCountersTitle: 'Токены, использованные за текущий ход — ↑ вход ↓ выход',
      agents: 'Агенты',
