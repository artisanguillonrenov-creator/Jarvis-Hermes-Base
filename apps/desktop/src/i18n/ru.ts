...
export const ru = defineLocale({
  ...
  commandCenter: {
    ...
    stopGatewayConfirm: 'Остановить шлюз сообщений? Боты не будут отвечать, пока он не будет запущен снова.',
    gatewayActionPending: 'Другое системное действие всё ещё выполняется',
