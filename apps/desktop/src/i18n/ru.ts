...
export const ru = defineLocale({
  ...
  settings: {
    ...
    mcp: {
      ...
      discoveryTitle: 'Доступны на этом шлюзе',
      discoveryFind: 'Найти MCP-серверы',
      discoveryHint: 'Поиск в известных конфигах клиентов и на локальных слушающих портах. Программы при поиске не запускаются.',
      discoverySearching: 'Ищем MCP-серверы…',
      discoveryEmpty: 'Дополнительные MCP-серверы не найдены. Для нестандартных путей и защищённых адресов может потребоваться ручная настройка.',
      discoveryTarget: name => `Подключить для ${name}`,
