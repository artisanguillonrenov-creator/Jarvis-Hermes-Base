...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      linkOpenTitle: 'Открытие ссылок',
      linkOpenDesc:
        'Куда ведёт обычный щелчок по веб-ссылке. «В приложении» открывает панель предпросмотра; «Во внешнем» — системный браузер. ⌘/Ctrl-клик и средняя кнопка всегда открывают во внешнем браузере.',
      linkOpenInApp: 'В приложении',
      linkOpenExternal: 'Во внешнем',
