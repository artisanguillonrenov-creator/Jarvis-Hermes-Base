...
export const ru = defineLocale({
  ...
  commandCenter: {
    ...
    maintenance: {
      ...
      debugShareDesc: 'Загрузка анонимизированного отчёта и журналов; ссылки paste.rs удаляются через 6 ч, резервные ссылки dpaste.com хранятся 1 день и не могут быть удалены',
