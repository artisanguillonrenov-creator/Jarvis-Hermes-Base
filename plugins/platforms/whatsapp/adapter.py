...
class WhatsAppAdapter(WhatsAppBehaviorMixin, BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._whatsapp_mode_explicit = bool(str(env_mode or configured_mode or "").strip())
        self._whatsapp_mode = str(_extra_or_secret(extra, "mode", "WHATSAPP_MODE", "self-chat")).strip().lower()
