...
DEFAULT_SYSTEM_PATTERNS = [
    ...
    # the same rendered line.  Matching the stable header as a prefix keeps
    # the entire approval card out of peer-agent context.
    r"^\s*⚠(?:\uFE0F)?\s+\*{0,2}Dangerous (?:command|request) requires approval\*{0,2}(?:\s+|$)",
    r"^\s*This approval prompt has expired\b",
