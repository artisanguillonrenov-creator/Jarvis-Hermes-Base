...
class AIAgent(
    ...
    def _dispatch_delegate_task(self, function_args: dict) -> str:
        ...
        # MODEL dispatch policy is centralized with the registry fallback. The
        # hidden `background` argument stays ignored; direct Python callers do
        # not pass through this helper and retain explicit background control.
