...
export const ru: Translations = {
  ...
  kanban: {
    ...
    reclaimFirst: "Сначала вернуть задачу",
    ...
    assigneeLabelHint: "(пусто = назначит диспетчер)",
    skillsLabel: "Навыки",
    ...
    create: "Создать",
    boardSettingsTitle: "Настройки доски — название, описание и каталог проекта для новых задач",
    boardSettingsTitleFor: "Настройки доски — {name}",
    projectDirectoryOverrideHint: "Новые задачи наследуют этот каталог; при создании задачи его можно изменить.",
    saving: "Сохранение…",
    taskCount: {
      one: "{n} задача",
      few: "{n} задачи",
    ...
    boardSwitchAriaLabel: "Переключить доску Kanban",
    boardIndependenceHint: "Доски — независимые рабочие потоки. У каждой свои задачи, группы и исполнители.",
    createBoardHint: "Создать новую доску для отдельного рабочего потока, проекта или команды.",
    orchestrationSettings: "Настройки оркестрации",
    orchestrationLabel: "Оркестрация: ",
    orchestrationAuto: "Авто",
    orchestrationManual: "Вручную",
    orchestrationLoadingMode: "Загрузка режима…",
    orchestrationAutoTitle: "Оркестрация: авто — диспетчер автоматически разбивает новые задачи сортировки на каждом цикле. Нажмите, чтобы перейти в ручной режим.",
    orchestrationManualTitle: "Оркестрация: вручную — задачи остаются в сортировке, пока вы не запустите ⚗ Decompose. Нажмите, чтобы включить авто.",
    orchestrationConfigureTitle: "Настроить оркестратор Kanban: профиль, исполнитель по умолчанию, авторазбиение и описания профилей",
    orchestrationReload: "Перезагрузить",
    orchestrationLoadFailed: "Не удалось загрузить: {error}",
    orchestrationSettingsSaved: "Настройки сохранены.",
    orchestrationSaveFailed: "Не удалось сохранить: {error}",
    orchestratorProfile: "Профиль оркестратора",
    defaultAssignee: "Исполнитель по умолчанию",
    defaultProfileValue: "(по умолчанию: {profile})",
    resolvedProfile: "Итоговый профиль: {profile}",
    orchestrationMode: "Режим оркестрации",
    autoDecomposeTriage: "Автоматически разбирать задачи сортировки",
    autoDecomposeOnHelp: "Диспетчер автоматически разбирает новые задачи сортировки.",
    autoDecomposeOffHelp: "Задачи остаются в сортировке, пока вы не нажмёте ⚗ Decompose.",
    profileDescriptions: "Описания профилей",
    profileDescriptionsHelp: "Описания помогают маршрутизации. Нажмите ⚗ для автогенерации либо измените текст и сохраните.",
    noProfilesInstalled: "Профили не установлены.",
    defaultProfileTag: "(по умолчанию)",
    autoReviewTag: "авто — проверить",
    profileDescriptionPlaceholder: "Для каких задач подходит этот профиль?",
    saveDescriptionTitle: "Сохранить описание как пользовательское",
    autoGenerateDescriptionTitle: "Сгенерировать описание по навыкам и модели профиля",
    generating: "Генерация…",
    autoGenerate: "⚗ Авто",
    descriptionSaved: "Описание профиля {name} сохранено.",
    autoGeneratedDescription: "Описание профиля {name} сгенерировано автоматически.",
    autoGenerateFailed: "Не удалось сгенерировать описание: {error}",
    attachments: "Вложения",
    uploading: "Загрузка…",
    uploadFile: "Загрузить файл",
    noAttachments: "— вложений нет —",
    removeAttachment: "Удалить вложение",
    confirmRemoveAttachment: "Удалить это вложение?",
    addParentButton: "+ родитель",
    addChildButton: "+ потомок",
    refreshLog: "Обновить журнал",
    emptyLog: "(пусто)",
    editDescription: "Изменить описание",
    earlierAttempts: "+{n} более ранних",
    metadata: "Метаданные",
    goalMode: "Целевой режим",
    goalOn: "включён",
    goalOnMaxTurns: "включён (макс. {n} ходов)",
    finalResult: "Итоговый результат (сводка запуска)",
    doneParentNote: "Эта карточка — задача-оркестратор / родитель. Основной результат смотрите в разделе результатов потомков.",
    doneNoResult: "Итоговый результат не записан. Проверьте историю запусков, журналы или задачи-потомки.",
    childResults: "Результаты потомков",
    noChildResult: "Результат пока не записан.",
    commentHint: "Комментарии передаются воркеру при следующем запуске или вызове kanban_show() — заранее блокировать задачу не нужно.",
    commentHintTitle: "Комментарии — канал связи с воркером задачи. Они сразу попадают в тред. Работающий воркер увидит их при следующем kanban_show() или перезапуске; блокируйте задачу только если хотите остановить воркер и дождаться вашего ввода.",
    eventKinds: {
      archived: "архивировано",
      assigned: "назначен исполнитель",
      attached: "вложение добавлено",
      attachment_removed: "вложение удалено",
      block_loop_detected: "обнаружен цикл блокировки",
      blocked: "заблокировано",
      changes_requested: "запрошены изменения",
      claim_extended: "захват продлён",
      claim_rejected: "захват отклонён",
      claimed: "взято в работу",
      commented: "добавлен комментарий",
      completed: "завершено",
      completion_blocked_hallucination: "завершение заблокировано из-за фантомной ссылки",
      created: "создано",
      decomposed: "разбито на подзадачи",
      dependency_wait: "ожидание зависимости",
      descendant_invalidated: "потомок сброшен",
      edited: "изменено",
      gave_up: "воркер остановился",
      heartbeat: "сигнал активности",
      linked: "связь добавлена",
      model_override_set: "модель переопределена",
      promoted: "переведено дальше",
      promoted_manual: "переведено вручную",
      reasoning_effort_set: "уровень рассуждения изменён",
      reclaim_deferred: "возврат отложен",
      reclaimed: "возвращено",
      reconciled: "состояние согласовано",
      respawn_guarded: "перезапуск предотвращён",
      review_reopened: "ревью переоткрыто",
      review_requested: "запрошено ревью",
      scheduled: "запланировано",
      spawned: "воркер запущен",
      specified: "спецификация создана",
      stale: "устарело",
      status: "статус",
      suspected_hallucinated_references: "подозрение на фантомные ссылки",
      timed_out: "тайм-аут",
      tip_scratch_workspace: "совет по временной рабочей области",
