...
export const ru: Translations = {
  ...
  app: {
    ...
    currentProfileOption: "этот дашборд ({name})",
    memoryElevatedBanner: "У агента заканчивается память.",
    dismiss: "Скрыть",
  },
  ...
  cron: {
    ...
    delivery: {
      ...
      slack: "Slack",
      email: "Email",
      needsHomeChannel: "сначала укажите основной канал",
    },
  },
  ...
  profiles: {
    ...
    cloneFrom: "Скопировать конфигурацию из",
    ...
    activeSet: "Активный профиль назначен",
    ...
    cloneAll: "Скопировать всё (память, сессии, навыки, состояние)",
    noSkillsOption: "Не добавлять встроенные навыки",
    descriptionOptional: "Описание (необязательно)",
    modelOptional: "Модель (необязательно)",
    modelInherit: "Унаследовать от источника или по умолчанию",
    modelLoading: "Загрузка моделей…",
    modelNone: "Нет провайдеров с ключами — сначала добавьте ключ",
  ...
  kanban: {
    ...
    parentLabelHint: "(потомок заблокирован, пока не выполнена родительская)",
    create: "Создать",
    ...
    trash: {
      ...
      confirmManyTitle: "Удалить задач: {n}?",
    },
  },
};
