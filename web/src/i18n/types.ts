...
export interface Translations {
  ...
  kanban: {
    ...
    // Optional strings used by newer Kanban controls. Keeping these optional
    // lets locales that have not translated them yet continue using the
    // plugin's English fallback without forcing synchronized catalog churn.
    taskCount?: {
      one?: string;
      few?: string;
      many?: string;
    ...
    boardSwitchAriaLabel?: string;
    boardIndependenceHint?: string;
    createBoardHint?: string;
    clearFilters?: string;
    delete?: string;
    setPriority?: string;
    reclaimFirst?: string;
    ...
    orchestrationLoadingMode?: string;
    orchestrationAutoTitle?: string;
    orchestrationManualTitle?: string;
    orchestrationConfigureTitle?: string;
    orchestrationReload?: string;
    orchestrationLoadFailed?: string;
    orchestrationSettingsSaved?: string;
    orchestrationSaveFailed?: string;
    orchestratorProfile?: string;
    defaultAssignee?: string;
    defaultProfileValue?: string;
    resolvedProfile?: string;
    orchestrationMode?: string;
    autoDecomposeTriage?: string;
    autoDecomposeOnHelp?: string;
    autoDecomposeOffHelp?: string;
    profileDescriptions?: string;
    profileDescriptionsHelp?: string;
    noProfilesInstalled?: string;
    defaultProfileTag?: string;
    autoReviewTag?: string;
    profileDescriptionPlaceholder?: string;
    saveDescriptionTitle?: string;
    autoGenerateDescriptionTitle?: string;
    generating?: string;
    autoGenerate?: string;
    descriptionSaved?: string;
    ...
    eventPayloadKeys?: Record<string, string>;
  };
}
