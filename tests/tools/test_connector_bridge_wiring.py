...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"calls": [{"name": "tool_search", "arguments": {}}]}, "itself a bridge tool"),
        ({"calls": [{"name": "x"}]}, "requires an 'arguments' object"),
        ({"calls": [{"name": "x", "parameters": {"q": "value"}}]}, "not 'parameters'"),
        ({"calls": [{"name": "x", "arguments": None}]}, "requires an 'arguments' object"),
        ({"name": "x"}, "requires an 'arguments' object"),
