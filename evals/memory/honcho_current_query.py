"""Honcho 2.4 SDK/local HTTP lifecycle probe; no hosted service or model inference.

Run with isolated HOME/HERMES_HOME and honcho-ai==2.4.0 installed (or on PYTHONPATH):
