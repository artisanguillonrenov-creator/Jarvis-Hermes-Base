...
DEFAULT_MUSE_STT_MODEL = "muse-voice-transcribe-1.0"
...
MUSE_STT_BASE_URL = "https://api.meta.ai/v1"
...
BUILTIN_STT_PROVIDERS = frozenset({
    "local", "local_command", "groq", "openai", "mistral", "xai", "elevenlabs", "deepinfra", "muse"})
