...
def _native_screenshot_result(result: Dict[str, Any], path: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        from tools.vision_tools import (_EMBED_MAX_DIMENSION, _resolve_embed_target_bytes,
        ...
        data_url = _resize_image_for_vision(Path(path), mime_type="image/png", max_base64_bytes=_resolve_embed_target_bytes(),
