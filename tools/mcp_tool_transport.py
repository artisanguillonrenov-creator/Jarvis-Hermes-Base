...
class MCPServerTransportMixin:
    ...
    async def _run_stdio(self, config: dict):
        ...
        # `args:` with no value is YAML null; .get's default only covers a missing key.
        command, args = await _core._preflight_stdio_command(self.name, command, config.get("args") or [])
