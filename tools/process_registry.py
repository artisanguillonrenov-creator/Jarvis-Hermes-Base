...
class ProcessRegistry(ProcessCheckpointMixin):
    ...
    def wait_for_pending_completions(
        ...
        # A relay waiter has a protocol deadline longer than the general
        # one-shot default. Its explicit completion contract keeps the parent
        # alive until the Desktop can write its terminal reply; unrelated
        # background work retains the configured bound.
