...
def _bump_server_error(server_name: str, *, application: bool = False, tool_name: Optional[str] = None) -> None:
    ...
    *application*: the call completed and the payload was an error (transport is fine); *tool_name*
    ...
    all_application = application and (n == 1 or _server_errors_all_application.get(key, False))
